const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_BONEMERANG] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_TWO_STRIKES | FLAG_DMG_IN_AIR | FLAG_DMG_UNGROUNDED_IGNORE_TYPE_IF_FLYING,
        .split = SPLIT_PHYSICAL,
    },
    ...
    [MOVE_NEEDLE_ARM] =
    {
        ...
        #endif
        .effect = EFFECT_HIT_SET_ENTRY_HAZARD, // Repurposed as Ceaseless Edge, but for Hidden Thorns
        .power = 65,
        .type = TYPE_GRASS,
        .accuracy = 90,
        .pp = 15,
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .argument = 66, // restores 66% HP instead of 50% HP
    },
    ...
    [MOVE_DIRE_CLAW] =
    {
        .effect = EFFECT_TRI_ATTACK, // Tri attack is the closest effect to Dire Claw's real effect
        .power = 80,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_WAVE_CRASH] =
    {
        .effect = EFFECT_RECOIL_33, // Wave Crash is now basically Double Edge, but with less PP.
        .power = 120,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_CHLOROBLAST] =
    {
        .effect = EFFECT_STEEL_BEAM, // EFFECT_CHLOROBLAST,
        .power = 150,
        .type = TYPE_GRASS,
        .accuracy = 95,
        .pp = 5,
    ...
    [MOVE_BARB_BARRAGE] =
    {
        .effect = EFFECT_HIT_SET_ENTRY_HAZARD, // Repurosed as Ceaseless Edge, but for Toxic Spikes
        .power = 65,
        .type = TYPE_POISON,
        .accuracy = 90,
        .pp = 15,
    ...
    [MOVE_SHELTER] =
    {
        .effect = EFFECT_DEFENSE_UP_3, // Changed from 2 stages to make it stand out
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_ICE_TUSK] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT | FLAG_STRONG_JAW_BOOST,
        .split = SPLIT_PHYSICAL,
    },
